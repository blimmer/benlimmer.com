...
tldr: Rapidly increase adoption of an event-driven architecture by auto-publishing events when database changes occur.
---

import MdxImage from "src/components/MdxImage.astro";
import hygenCreateHandler from "./assets/hygen-create-handler.png";
...
<MdxImage
  src={hygenCreateHandler}
  alt="A hygen code generator walking the user through creating a new EventBridge target"
/>
