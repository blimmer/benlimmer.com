...
import prevmod from "./assets/PrevMod.png";
import modshareprestoolbar from "./assets/ModSharePresToolbar.png";
import newmodfullres from "./assets/NewModFullRes.png";
import previcons from "./assets/PrevIcons.png";
import newicons from "./assets/NewIcons.png";
import muchborders from "./assets/MuchBorders.png";

<MdxImage src={prevmod} alt="Legacy ReadyTalk Conference Controls" />
...
<MdxImage
  src={modshareprestoolbar}
  alt="Highlighted Presentation and Bottom Toolbar on Legacy Conference Controls application"
/>
...
<MdxImage src={previcons} alt="Icons from the Legacy Conference Controls Application" />

[David Demmer](https://twitter.com/ddchili) came up with these excellent new icons.

<MdxImage src={newicons} alt="Icons from the New and Improved Conference Controls Application" />
...
<MdxImage src={muchborders} alt="Much Borders. So separation. Wow." />
...
<MdxImage src={newmodfullres} alt="The Phase 1, new-and-improved ReadyTalk conference controls application" />
