---
description: A description of Ben Limmer's involvement in developing the ReadyTalk Video Conferencing Product
title: "ReadyTalk: Video Conferencing"
---

import MdxImage from "src/components/MdxImage.astro";
import vciMacComp from "./assets/VCiMacComp.png";
import red5 from "./assets/Red5.png";

<MdxImage src={vciMacComp} alt="ReadyTalk Video Conferencing on an iMac" />

After completing my first small project at ReadyTalk, [QuickLauncher](/portfolio/rt/quicklauncher), I was excited to be
chosen to work on the company's highest priority project, Video Conferencing.
...
<MdxImage src={red5} alt="Red5 logo" />
