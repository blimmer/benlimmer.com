...
tags:
  ...
  - startups
description: >-
  A writeup of Ben Limmer's favorite presentations at the March 2013 Denver New Tech Meetup held at Galvanize in Denver,
  Colorado, USA.
---

import MdxImage from "src/components/MdxImage.astro";
import PiqLogo from "./assets/piq_logo.png";
import Adafruitcase from "./assets/adafruitcase.jpg";
...
<MdxImage src={PiqLogo} alt="Logo for Piq" />
...
<MdxImage src={Adafruitcase} alt="Ada FruitCase Arduino board" />
