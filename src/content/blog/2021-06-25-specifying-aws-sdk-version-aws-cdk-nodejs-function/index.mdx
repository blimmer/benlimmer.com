...
import BundlingOptionsExternalModules from "./assets/bundling-options-external-modules.png";
import LambdaRuntimeVersionInfo from "./assets/lambda-runtime-version-info.png";
...
<MdxImage src={BundlingOptionsExternalModules} alt="screenshot of the aws-cdk bundling options documentation page" />
...
<MdxImage
  src={LambdaRuntimeVersionInfo}
  alt="screenshot of the bundled aws-sdk version available in the Node.js lambda runtime"
/>
