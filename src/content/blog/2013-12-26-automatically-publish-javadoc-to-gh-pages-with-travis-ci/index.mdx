...
import GhAccessToken from "./assets/GhAccessToken.png";
...
3.  [Create a GitHub Access Token](https://github.com/settings/tokens) for Travis. As I mentioned, this will allow
    ...
    [repo scope](https://help.github.com/en/articles/creating-a-personal-access-token-for-the-command-line), otherwise
    you will get "permission denied" errors on push.

    <MdxImage src={GhAccessToken} alt="GitHub Create New Personal Access Token" />
