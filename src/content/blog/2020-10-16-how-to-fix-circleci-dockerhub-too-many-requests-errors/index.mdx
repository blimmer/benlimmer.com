...
import NewAccessToken from "./assets/new-access-token.png";
import GeneratedAccessToken from "./assets/generated-access-token.png";
import NewContext from "./assets/new-context.png";
...
1. **Create a DockerHub access token**. This token is how you'll authenticate your build's Docker image pulls. Visit
   ...
   <MdxImage src={NewAccessToken} alt="create a new access token on hub.docker.com" />

   <MdxImage src={GeneratedAccessToken} alt="generated access token" />
...
1. **Create a CircleCI context** for DockerHub. You'll use this [context](https://circleci.com/docs/2.0/contexts/) to
   ...
   <MdxImage src={NewContext} alt="create a new circleci context" />
