...
import PopeCameraPhone from "./assets/PopeCameraPhone.png";
...
I mentioned in an [earlier post](/blog/2013/09/05/en-route-to-blendconf) that I wasn't sure how the whole 'no device'
event would go over. I believe that the device-free environment made BlendConf stand out from other events I've
...
<MdxImage src={PopeCameraPhone} alt="2005 vs. 2013 and cameraphones during the Papal inaugration" />
